...
@Entity
@Table(name = "regitem_subtypes")
@Data
@NoArgsConstructor
public class RegitemSubtypes implements java.io.Serializable {
	...
	private Set<RegitemSubsubtypes> regitemSubsubtypeses = new HashSet<RegitemSubsubtypes>(0);
